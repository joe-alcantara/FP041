...
k-NN is a simple yet effective classification algorithm that works based on the premise that the closer two data points are together, the more likely they are of the same class. Lets consider a simple example with tumor size and whether they are benign or malignant.



It classifies a data point by considering the class labels of its k-nearest neighbors in the feature space.
