...
Consider the following diagram (figure 1). The blue dots are rejected ball bearings  and the orange dots are accepted.

![](images/classification1.png){width="80%"}

Is there a rule we can apply here?

What happens then, we have a new ballbearing (indicated by the yellow dot) that hasn't been classified? (figure 2)
what would you classify this as using this rule?

![](images/classificationNewInstance.png)

What happens if they are a bit more mixed up? (figure 3)
Is there a rule?

![](images/classification2.png)

Now, we add a new ballbearing for you to identify. (figure 4)
What would you class this as?

![](images/classification2NewInstance.png)
...
Blue wins (meaning we class the yellow dot as accepted) because there are more blue dots (2) than orange dots (1) to the yellow dot (figure 5).

![](images/classification2NewInstance-01.png)
...
### Measure the distance between each ballbearing and the first ballbearing.

| Ballbearing Mass | Ballbearing Size | Classification | Mass Distance | Size Distance | Total Distance |
|------------|------------|----------------|-----|-----|-----|
| 3.1        | 4.3        | Rejected      | $(3.1 - 2.8)^2$ | $(4.3-2.3)^2$ | 4.09 |
| 0.9        | 2.2        | Accepted         | $(0.9 - 2.8)^2$ | $(2.2 - 2.3)^2$ | 3.62 |
| 3.2        | 3.5        | Rejected      | $(3.2 - 2.8)^2$ | $(3.5 - 2.3)^2$ | 1.6 |
| 1.2        | 1.5        | Accepted         | $(1.2 - 2.8)^2$ | $(1.5 - 2.3)^2$ | 3.2 |
| 3.2        | 3.3        | Rejected      |  $(3.2 - 2.8)^2$ | $(3.3 - 2.3)^2$ | 1.16 |
| 4.6        | 2.6        | Rejected      | $(4.6 - 2.8)^2$ | $(2.6 - 2.3)^2$ | 3.33 |
| 4.3        | 2.5        | Rejected      | $(4.3 - 2.8)^2$ | $(2.5 - 2.3)^2$ | 2.29 |
| 2.0        | 3.2        | Accepted         | $(2.0 - 2.8)^2$ | $(3.2 - 2.3)^2$ | 1.45 |
| 2.4        | 2.9        | Accepted         | $(2.4 - 2.8)^2$ | $(2.9 - 2.3)^2$ | 0.52 |

### Order by Absolute Distance to 1. from least distance to most distance.

| Ballbearing Mass | Ballbearing Size | Classification | Total Distance |
|------------|------------|----------------|-----|-----|-----|
| 2.4        | 2.9        | Accepted         | 0.52 |
| 3.2        | 3.3        | Rejected      | 1.16 |
| 2.0        | 3.2        | Accepted         | 1.45 |
| 3.2        | 3.5        | Rejected      | 1.6 |
| 4.3        | 2.5        | Rejected      | 2.29 |
| 1.2        | 1.5        | Accepted         | 3.2 |
| 4.6        | 2.6        | Rejected      | 3.33 |
| 0.9        | 2.2        | Accepted         | 3.62 |
| 3.1        | 4.3        | Rejected      | 4.09 |

K-NN = 1, is the closest. It's classification is Accepted
K-NN = 3, is the closest 3. The classifications are 2 Accepted, 1 Rejected. Therefore it's classification is Accepted
K-NN = 5, is the closest 5. The classificaitons are 3 Rejected, 2 Accepted. Therefore it's classification is Rejected.


### Measure the distance between each ballbearing and the second ballbearing.

| Ballbearing Mass | Ballbearing Size | Classification | Mass Distance | Size Distance | Total Distance |
|------------|------------|----------------|-----|-----|-----|
| 3.1        | 4.3        | Rejected      | $(3.1 - 3.9)^2$ | $(4.3-2.1)^2$ | 5.48 |
| 0.9        | 2.2        | Accepted         | $(0.9 - 3.9)^2$ | $(2.2 - 2.1)^2$ | 9.01 |
| 3.2        | 3.5        | Rejected      | $(3.2 - 3.9)^2$ | $(3.5 - 2.1)^2$ | 2.45 |
| 1.2        | 1.5        | Accepted         | $(1.2 - 3.9)^2$ | $(1.5 - 2.1)^2$ | 7.65 |
| 3.2        | 3.3        | Rejected      |  $(3.2 - 3.9)^2$ | $(3.3 - 2.1)^2$ | 1.93 |
| 4.6        | 2.6        | Rejected      | $(4.6 - 3.9)^2$ | $(2.6 - 2.1)^2$ | 0.74 |
| 4.3        | 2.5        | Rejected      | $(4.3 - 3.9)^2$ | $(2.5 - 2.1)^2$ | 0.32 |
| 2.0        | 3.2        | Accepted         | $(2.0 - 3.9)^2$ | $(3.2 - 2.1)^2$ | 4.82 |
| 2.4        | 2.9        | Accepted         | $(2.4 - 3.9)^2$ | $(2.9 - 2.1)^2$ | 2.89 |

### Order by Absolute Distance to 2. from least distance to most distance.

| Ballbearing Mass | Ballbearing Size | Classification | Mass Distance | Size Distance | Total Distance |
|------------|------------|----------------|-----|-----|-----|
| 4.3        | 2.5        | Rejected      | 0.32 |
| 4.6        | 2.6        | Rejected      | 0.74 |
| 3.2        | 3.3        | Rejected      | 1.93 |
| 3.2        | 3.5        | Rejected      | 2.45 |
| 2.4        | 2.9        | Accepted         | 2.89 |
| 2.0        | 3.2        | Accepted         | 4.82 |
| 3.1        | 4.3        | Rejected      | 5.48 |
| 1.2        | 1.5        | Accepted         | 7.65 |
| 0.9        | 2.2        | Accepted         | 9.01 |


K-NN = 1, is the closest. It's classification is Rejected
K-NN = 3, is the closest 3. The classifications are 3 Rejected. Therefore it's classification is Rejected
K-NN = 5, is the closest 5. The classificaitons are 4 Rejected, 1 Accepted. Therefore it's classification is Rejected.

### Measure the distance between each ballbearing and the third ballbearing.

| Ballbearing Mass | Ballbearing Size | Classification | Mass Distance | Size Distance | Total Distance |
|------------|------------|----------------|-----|-----|-----|
| 3.1        | 4.3        | Rejected      | $(3.1 - 0.7)^2$ | $(4.3-4.6)^2$ | 5.85 |
| 0.9        | 2.2        | Accepted         | $(0.9 - 0.7)^2$ | $(2.2 - 4.6)^2$ | 5.8 |
| 3.2        | 3.5        | Rejected      | $(3.2 - 0.7)^2$ | $(3.5 - 4.6)^2$ | 7.46 |
| 1.2        | 1.5        | Accepted         | $(1.2 - 0.7)^2$ | $(1.5 - 4.6)^2$ | 9.86 |
| 3.2        | 3.3        | Rejected      |  $(3.2 - 0.7)^2$ | $(3.3 - 4.6)^2$ | 7.94 |
| 4.6        | 2.6        | Rejected      | $(4.6 - 0.7)^2$ | $(2.6 - 4.6)^2$ | 19.21 |
| 4.3        | 2.5        | Rejected      | $(4.3 - 0.7)^2$ | $(2.5 - 4.6)^2$ | 17.37 |
| 2.0        | 3.2        | Accepted         | $(2.0 - 0.7)^2$ | $(3.2 - 4.6)^2$ | 3.65 |
| 2.4        | 2.9        | Accepted         | $(2.4 - 0.7)^2$ | $(2.9 - 4.6)^2$ | 5.78 |

### Order by Absolute Distance to 1. from least distance to most distance.

| Ballbearing Mass | Ballbearing Size | Classification | Mass Distance | Size Distance | Total Distance |
|------------|------------|----------------|-----|-----|-----|
| 2.0        | 3.2        | Accepted         | 3.65 |
| 2.4        | 2.9        | Accepted         | 5.78 |
| 0.9        | 2.2        | Accepted         | 5.8 |
| 3.1        | 4.3        | Rejected      | 5.85 |
| 3.2        | 3.5        | Rejected      | 7.46 |
| 3.2        | 3.3        | Rejected      | 7.94 |
| 1.2        | 1.5        | Accepted         | 9.86 |
| 4.3        | 2.5        | Rejected      | 17.37 |
| 4.6        | 2.6        | Rejected      | 19.21 |

K-NN = 1, is the closest. It's classification is Accepted
K-NN = 3, is the closest 3. The classifications are 3 Accepted. Therefore it's classification is Accepted
K-NN = 5, is the closest 5. The classificaitons are 3 Accepted, 2 Rejected. Therefore it's classification is Rejected.
