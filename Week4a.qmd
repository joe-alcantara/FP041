...
Example: The Gini index for the United States was .41 in 1997 and grew to .45 in 2007
and is now 39.8 as of 2021

We can also use visualisations to illustrate
...
1. Work out the cumulative frequency (cf) for each value (ie. Add up the frequencies as
you go along to obtain a running total)
...
5
Results
• “1-5” is not a number, nor is “6-10” etc
• We could use the mid value for each and then find the averages
...
Q1 is ( n+1
4 )th value, Q3 is ( n+3
4 )th value

Example
Gp A: 3, 3, 4, 4, 4, 5, 5
Q1 Is ( 7+1
4 )th = 2nd value = 3, Q3 is ( n+1
4 )th = 6th value = 5
...
Gp B: 0, 1, 3, 3, 4, 7, 10
Q1 Is ( n+1
4 )th value = 1, Q3 is ( n+1
4 )th value = 7
IQR = Q3 - Q1= 7 - 1 = 6


The IQR is usually preferable to the range because it is unaffected by outliers (extreme values)
Gp A: 3, 3, 4, 4, 4, 5, 5 Range = 2, IQR = 2
If the highest response had been 50 hrs Gp A: 3, 3, 4, 4, 4, 5, 50
Range = 47, IQR = 2
IQR is better because 50 might have been a typo or a lie. Even if
the 50 was true, the IQR is more representative of the whole group

Box and Whisker Plots
Figure: Illustration of IQR
...
Using the calculations on the previous slide
Gp A: 4, 5, 3, 4, 5, 3, 4
√ 116−7(42)
7−1 = 0.816
Gp B: 0, 3, 10, 1, 7, 3, 4
